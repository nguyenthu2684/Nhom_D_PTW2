...
<div class="container">
     <div class="imformation">
        ...
        <div class="noiDung"> 
            <p><b>Bác sĩ Cơ Xương Khớp giỏi</b>
     ...
     <div class="row bsi">
        <div class="col-md-6">
            <div class="row ">
                <div class="col-md-2">
                <img src="https://cdn.bookingcare.vn/fr/w200/2018/04/09/151800292142135730131997187173031663525568184320n.jpg" width="80" height="80" alt="#"></img>
                    <a href="#">xem thêm</a>
                </div>
                <div class="col-md-10">
                    <div class="thongTin">
        ...
        <div class="col-md-6">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="#">Thứ 3 - 15/11</a></li>
                  <li><a class="dropdown-item" href="#">Thứ 4 - 16/11</a></li>
                  <li><a class="dropdown-item" href="#">Thứ 5 - 17/11</a></li>
                </ul>
              </div> 
              <p>LỊCH KHÁM</p>
            <div class="row">
